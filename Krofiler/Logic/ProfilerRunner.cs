...
namespace Krofiler
{
	class ProfilerRunner
	{
		...
		internal void Start(string exePath, string args, ProfileAppOptions options)
		{
			...
			profileProcess.StartInfo.Arguments = $"--profile=log:nodefaults,heapshot=ondemand,gcalloc,gcmove,gcroot,counter,maxframes={options.MaxFrames},output=\"{LogFilePath}\" \"{exePath}\" {args}";
